...
app.get("*", function (req, res) {
    ...
    res.send((0, _renderer2.default)(req, store)); // Pass req to the renderer to let it figure out what the base path is (it will only ever be '/')...
});
...
exports.default = function (req, store) {
    var content = (0, _server.renderToString)( // The html skeleton of our app (without javascript). Render to string removes it... And context is a mandatory prop.
